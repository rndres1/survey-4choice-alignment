var plugin_6choice = (function (jspsych) {
  "use strict";
    ...
    trial(display_element, trial)
    {
      ...
      <div class="outer-container">
        ...
        <div class="container">
            ...
            <img src="${trial.image_fnames[4]}" class="image" id="image05">
            <img src="${trial.image_fnames[5]}" class="image" id="image06">
        </div>
        <div>
  ...
  plugin_6choice.info = info;

  return plugin_6choice;
})(jsPsychModule);